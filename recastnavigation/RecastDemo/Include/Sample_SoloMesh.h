...
public:
	...
	void applySettings(float agentRadius, float agentHeight, float cellSize, float AgentMaxClimb, float AgentMaxSlope);
	void setOffMeshConnectionsFromFile(const std::string& filePath);
	void setOffMeshConnections(const std::vector<OffMeshConnectionStruct>& connections);
